...
que lo que hace es seleccionar 5 clientes del total y continuar el tratamiento de datos solo con ellos. Cuando dicha opción está en **False** se vio de que el docker puede
...
la memoria dedicada a la aplicación.
